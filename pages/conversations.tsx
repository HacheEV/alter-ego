                                        ...
                                        return (
                                            <li key={index}
                                                ...
                                                <div className="w-full flex flex-col items-center py-6 px-3">
                                                    <div
                                                        style={{ "--user-color": conversation.profiles.color.toString() } as React.CSSProperties}
                                                        className={classNames("w-16 h-16 rounded-full my-2 flex items-center justify-center border-[3px] border-user")}>
                                                        <div
